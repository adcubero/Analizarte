...
class OptionsControllerTest < ActionController::TestCase
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post :create, option: { correct: @option.correct, option: @option.option, sentence_id: @option.sentence_id }
    end
  ...
  test "should update option" do
    patch :update, id: @option, option: { correct: @option.correct, option: @option.option, sentence_id: @option.sentence_id }
    assert_redirected_to option_path(assigns(:option))
  end
