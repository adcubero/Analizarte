...
class KidsControllerTest < ActionController::TestCase
  ...
  test "should create kid" do
    assert_difference('Kid.count') do
      post :create, kid: { age: @kid.age, email: @kid.email, name: @kid.name, password: @kid.password, tutor_id: @kid.tutor_id }
    end
  ...
  test "should update kid" do
    patch :update, id: @kid, kid: { age: @kid.age, email: @kid.email, name: @kid.name, password: @kid.password, tutor_id: @kid.tutor_id }
    assert_redirected_to kid_path(assigns(:kid))
  end
