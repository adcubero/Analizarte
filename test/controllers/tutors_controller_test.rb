...
class TutorsControllerTest < ActionController::TestCase
  ...
  test "should create tutor" do
    assert_difference('Tutor.count') do
      post :create, tutor: { age: @tutor.age, email: @tutor.email, name: @tutor.name, password: @tutor.password }
    end
  ...
  test "should update tutor" do
    patch :update, id: @tutor, tutor: { age: @tutor.age, email: @tutor.email, name: @tutor.name, password: @tutor.password }
    assert_redirected_to tutor_path(assigns(:tutor))
  end
